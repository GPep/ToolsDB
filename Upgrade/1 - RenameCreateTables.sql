...
BEGIN
EXECUTE SP_RENAME 'ClusterNode', 'ClusterNodeOld'
END

IF OBJECT_ID('ClusterNodeNotification','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'ClusterNodeNotification', 'ClusterNodeNotificationOld'
END

IF OBJECT_ID('CRJobs','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'CRJobs', 'CRJobsOld'
END

IF OBJECT_ID('DBGrowthRate','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'DBGrowthRate', 'DBGrowthRateOld'
END

IF OBJECT_ID('Disk_Size','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'Disk_Size', 'Disk_SizeOld'
END

IF OBJECT_ID('ServerRoles','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'ServerRoles', 'ServerRolesOld'
END

IF OBJECT_ID('SQLLogins','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME  'SQLLogins', 'SQLLoginsOld'
END

IF OBJECT_ID('tblWhoIsActive','u') IS NOT NULL
BEGIN
EXECUTE SP_RENAME 'tblWhoIsActive', 'tblWhoIsActiveOld'
END
