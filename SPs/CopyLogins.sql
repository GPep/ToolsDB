...
IF OBJECT_ID('CopyLogins') IS NULL
  EXEC ('CREATE PROCEDURE CopyLogins AS RETURN 0;')
GO

ALTER PROCEDURE [dbo].[CopyLogins]
...
-- logins to partner server specified - to be used
